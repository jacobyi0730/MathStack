...
| **E. 타격감·사운드** | T-059 → T-060 | `src/engine/effects`, `src/entities/particle·shockwave`, `src/systems/feedback`, `src/audio/`, `public/audio/` |
...
| BGM | 효과음은 T-060 에서 도입했다. 배경음은 교실 부담과 대역폭을 다시 판단해야 해 v1 제외 |
